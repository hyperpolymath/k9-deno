...
// Replace k9-deno, K9 Deno — See README.adoc for details., just run, K9 Deno started successfully. with actuals
= k9-deno — Quick Start for Users
:toc:
:toclevels: 2

== What is k9-deno?

K9 Deno — See README.adoc for details.
...
----
# Clone and set up
git clone https://github.com/hyperpolymath/k9-deno.git
cd k9-deno
just setup
----
...
[source,bash]
----
just install --portable --prefix=./k9-deno-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/k9-deno/wiki
